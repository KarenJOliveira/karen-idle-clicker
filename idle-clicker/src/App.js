import Cabecalho from './components/Cabeçalho/Cabeçalho.js'
  ...
  const handleClick = (e) => {
    ...
    switch (id) {
      ...
      case "construirBtn":
        ...
        transacoes.construir.madeira, ouro: prevState.ouro + 
        transacoes.construir.ouro, casa: prevState.casa + transacoes.construir.casa }));
        }
        break;
      case "contratarLenhadorBtn":
        ...
        transacoes.contratarLenhador.ouro, casa: prevState.casa + 
        transacoes.contratarLenhador.casa, trabalhador: prevState.trabalhador + 
